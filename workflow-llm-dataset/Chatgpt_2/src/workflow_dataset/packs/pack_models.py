...
class PackManifest(BaseModel):
    ...
    # M25E–M25H: Pack-driven behavior — prompt assets, task-level defaults (inspectable; no code execution)
    behavior: dict[str, Any] = Field(default_factory=dict, description="prompt_assets[], task_defaults[]")
