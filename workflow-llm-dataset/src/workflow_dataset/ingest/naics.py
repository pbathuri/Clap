"""Ingest NAICS hierarchy files into interim parquet and register sources."""
...
def ingest_naics(settings) -> list[dict[str, Any]]:
    root = Path(settings.paths.raw_official) / "naics"
    ...
    for f in root.rglob("*"):
        ...
        try:
            ...
            parquet_path = out / f"naics__{stem}.parquet"
