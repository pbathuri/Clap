...
class TrainingRunConfig(BaseModel):
    ...
    max_iters: int | None = Field(default=None, description="Override total training steps (e.g. for smoke run)")
...
class EvalResult(BaseModel):
    ...
    prediction_mode: str = Field(default="baseline", description="baseline | real_model")
